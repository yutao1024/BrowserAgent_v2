...
@sgl.function
def basic_qa(s, question): # TODO: how to pass parameters to the function?
    s += question
    s += sgl.assistant(sgl.gen("answer")) # TODO: update max_tokens
    return s
...
def main(llm, tokenizer, data_name, args):
    ...
    for epoch in range(max_func_call):
        ...
        if args.use_vllm:
            ...
            arguments = [{'question': prompt} for prompt in prompts]
            ...
            outputs = [state['answer'] for state in states]
        else:
