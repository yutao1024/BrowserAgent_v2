...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--checkpoints_root",
        default="/minimax-dialogue/ruobai/cogito/verl-tool/checkpoints",
        help="Root where training checkpoints are stored",
    )
    parser.add_argument(
        "--converted_root",
        default="/minimax-dialogue/ruobai/cogito/verl-tool/checkpoints_converted",
...
def model_convert(
    ...
    merger_cmd = [
        "python",
        "/minimax-dialogue/ruobai/cogito/verl/scripts/model_merger.py",
        "--backend",
        "fsdp",
        "--hf_model_path",
        str(base_model_repo),
