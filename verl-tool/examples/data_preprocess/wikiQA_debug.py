...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="data/wikiQA_debug", help="Output directory.")
    ...
    dataset = load_dataset("RUC-NLPIR/FlashRAG_datasets", "popqa")
    print(dataset)
...
Avoid incorrect formats that omit brackets around parameters or numeric values.\n\n"""
    ...
    print("Done! Train size:", len(train_dataset), "Dev size:", len(dev_dataset))
