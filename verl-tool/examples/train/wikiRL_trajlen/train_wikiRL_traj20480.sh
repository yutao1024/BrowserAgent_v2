...
max_response_length=20480 # bottleneck of the right side, will used in the training
...
run_name="${model_pretty_name}-trajlen_${max_response_length}"
...
PYTHONUNBUFFERED=1 python3 -m verl_tool.trainer.main_ppo \
    ...
    trainer.project_name='wikiRL_trajlen' \
