...
export HF_DATASETS_CACHE=/home/yutao/.cache/hf/datasets

set -x
dataset_name=wikiQA_debug
train_data=/home/zhiheng/cogito/verl-tool/data/$dataset_name/train.parquet
val_data=/home/zhiheng/cogito/verl-tool/data/$dataset_name/test.parquet
...
model_name=/home/yutao/model/qwen2.5-1000q-click/qwen2.5-7b-1000q-1e_6-old-click-1ep-checkpoint-200
...
max_obs_length=$max_prompt_length # Not the bottleneck, the obs is much shorter than this
temperature=0.5
...
run_name="${model_pretty_name}-baseline-0623"
...
PYTHONUNBUFFERED=1 python3 -m verl_tool.trainer.main_ppo \
    ...
    trainer.project_name='wikiRL_Qwen3_0611' \
