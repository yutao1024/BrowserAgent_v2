ray stop
CUDA_VISIBLE_DEVICES=0,2,3,4 ray start --head --dashboard-host=0.0.0.0  --num-cpus=32
...
max_response_length=8192 # bottleneck of the right side, will used in the training
...
run_name="MAP-3B-10K-${model_pretty_name}-${rl_alg}-n${n}-b${batch_size}-t${temperature}"
