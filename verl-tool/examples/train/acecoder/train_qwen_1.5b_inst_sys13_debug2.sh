...
model_name=VerlTool/acecoder-fsdp_agent-qwen_qwen2.5-coder-1.5b-grpo-n16-b128-t1.0-lr1e-6-69k-sys2-400-step
...
run_name_postfix="-69k-sys13-wt-debug"
...
python -m verl_tool.servers.serve --host $host --port $port --tool_type "python_code_with_test" --workers_per_tool 8 --done_if_invalid True &
server_pid=$!
