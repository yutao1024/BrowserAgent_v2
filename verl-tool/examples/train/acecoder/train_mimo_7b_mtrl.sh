...
gpu_memory_utilization=0.85 # higher gpu_memory_utilization will likely cause the vllm to OOM and get stuck, so set it to a lower value like 0.4 or 0.5
...
run_name_postfix="-69k-mtrl-sys8-new2-debug"
