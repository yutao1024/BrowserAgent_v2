...
max_prompt_length=4096 # bottleneck of the rollout, by default keep the right side
...
run_name="${model_pretty_name}-rolloutlen_${max_prompt_length}"
...
PYTHONUNBUFFERED=1 python3 -m verl_tool.trainer.main_ppo \
    ...
    trainer.project_name='wikiRL_rolloutlen' \
