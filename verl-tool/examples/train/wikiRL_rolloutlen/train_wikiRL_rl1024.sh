...
max_prompt_length=1024 # bottleneck of the rollout, by default keep the right side
max_response_length=5120 # bottleneck of the right side, will used in the training
max_obs_length=1024 # Not the bottleneck, the obs is much shorter than this
temperature=0.5
